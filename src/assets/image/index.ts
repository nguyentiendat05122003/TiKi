...
import accountAvatarDefault from '~/assets/image/avatar-accountDefault.png';
import avatarColor from '~/assets/image/avatar-color.png';
import edit from '~/assets/image/edit.png';
import phone from '~/assets/image/phone.png';
import message from '~/assets/image/message.png';
import lock from '~/assets/image/lock.png';
import security from '~/assets/image/secrity.jpg';
